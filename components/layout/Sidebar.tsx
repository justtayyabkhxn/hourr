...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow: '0 0 12px rgba(0,187,127,0.12)',
          }}
        >
        ...
        <span
          ...
          style={{ color: 'var(--text-1)', letterSpacing: '0.2em' }}
        >
          HOURR
        </span>
      </div>
          ...
          return (
            <Link
              ...
              style={active ? {
                ...
                border: '1px solid rgba(0,187,127,0.18)',
              } : {
                color: 'var(--text-2)',
            ...
            >
              ...
              <span style={{ display: 'flex', alignItems: 'center', color: active ? 'var(--accent)' : 'var(--text-3)', flexShrink: 0 }}>
                {icon}
              </span>
              {label}
            </Link>
      ...
      {/* Footer */}
      <div className="px-3 pb-3 flex flex-col gap-1.5" style={{ borderTop: '1px solid var(--border-soft)', paddingTop: 12 }}>
        {/* Clock */}
        {time && (
          <div
          ...
          >
            ...
            <span
              className="tabular-nums text-sm font-bold flex-1"
              style={{ fontFamily: 'ui-monospace, monospace', color: 'var(--accent)', letterSpacing: '0.08em' }}
            >
              {time}
            </span>
          </div>
